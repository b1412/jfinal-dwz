...
public abstract class PageInfoInterceptor extends PrototypeInterceptor {
    ...
    public void doIntercept(ActionInvocation ai) {
        ...
        pageInfo.pageNumber = controller.getParaToInt("pageNumber", 1);
        pageInfo.pageSize = controller.getParaToInt("pageSize", PageInfo.DEFAULT_PAGE_SIZE);
    ...
    public Page page(PageInfo pageInfo) {
        ...
        List<Filter> filters = pageInfo.filters;
        ...
        if (relations.isEmpty()) {
            ...
            return modelInstance.paginate(pageInfo.pageNumber, pageInfo.pageSize, select, sqlExceptSelect,
                    paras.toArray(new Object[] {}));
        } else {
            return Db.paginate(pageInfo.pageNumber, pageInfo.pageSize, select, sqlExceptSelect,
                    paras.toArray(new Object[] {}));
        }
    }
    ...
    private PageInfo injectPageInfo(String modelName, HttpServletRequest request) {
        ...
        if (StringKit.notBlank(sorterField)) {
            ...
            pageInfo.sorterField = sorterField;
            pageInfo.sorterDirection = sorterDirection;
        }
        return pageInfo;
    }
}
